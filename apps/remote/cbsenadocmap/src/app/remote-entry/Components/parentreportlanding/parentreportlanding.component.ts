...
//---------date formate ends ---
import { SharepointlistService } from '@dmsportal/core';
...
import { WebsocketService } from '@dmsportal/core';
...
@Component({
  selector: 'dmsportal-parentreportlanding',
...
export class ParentreportlandingComponent implements OnInit, AfterViewInit {
  ...
  async getRowData_Old(i:any){
    ...
    //       const mstTblItems = [responses[0]];
    //       const detTblItems = [responses[1]];
    
    //       //resolve(responses);
    
    //       if(mstTblItems.length >0 && detTblItems.length >0 ){
    //         const detailMasterData = detTblItems.map((t1:any) => ([                                     
    //           ...t1,
    //           ...mstTblItems.find((t2:any) => t2.mstTblKeyFld === t1.detTblKeyFld)
    //         ]));
    //         //this.rowData = detailMasterData;
  ...
  //   let mstApiUrl = "https://enadocreport.com/api/Report?type=View%20Report&user=All";
  //   let detApiUrl = "https://enadocreport.com/api/Report?type=View%20Report&user=All";
