export default function getDocDefinition(
  ...
  return (function() {
    ...
    const footer = PDF_WITH_FOOTER_PAGE_COUNT
      ? function(currentPage, pageCount) {
          return {
            text: ".                                                   -- THIS IS SYSTEM GENERATED DOCUMENT AND REQUIRES NO SIGNATURE --                            " + "(Page: " + currentPage.toString() + " of " + pageCount + ")   ",
            margin: [20]
          };
        }
      : null;
  ...
  function createHeaderCell(col) {
    ...
    let isColGroup = Object.prototype.hasOwnProperty.call(col, "children"); //col.hasOwnProperty("children");
