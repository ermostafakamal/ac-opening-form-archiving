...
@Component({
  selector: 'dmsportal-masterdetailsrenderer',
...
export class MasterdetailsrendererComponent implements OnInit, AfterViewInit {
  ...
  getRowData(i:any) {
    ...
    const apiUrl = "https://enadocreport.com/api/Report?type='" + listname + "'View%20Report&user=All" + selQry + "";
    
    // const listname = i.config.MasterListInfo.name;
    // const selQry = i.config.MasterListInfo.select;
    // const apiUrl2 = "https://portal.bergerbd.com/leaveauto/_api/web/lists/getByTitle('" + listname + "')/items?&$top=2000000&$select=" + selQry + "";
